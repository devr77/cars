export const metadata = {
  title: "Terms And Condition | CarsStore7x24",
  description: "Terms And Condition CarsStore7x24",
};
...
function page() {
  return (
    <div className="mx-auto p-4 md:w-10/12">
      ...
      <p>Last updated: 2024-08-28</p>
      <p>
        1. <b>Introduction</b>
      </p>
      <p>
        Welcome to <b>https://www.carsstore7x24.in/</b> (“Company”, “we”, “our”,
        “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>https://www.carsstore7x24.in/</b> (together or
        individually “Service”) operated by <b>https://www.carsstore7x24.in/</b>
        .
      </p>
      <p>
      ...
      <p>
        ...
        <b>carsstore7x24@gmail.com</b> so we can try to find a solution. These
      ...
      <p>
        https://www.carsstore7x24.in/ has the right but not the obligation to
        monitor and edit all Content provided by users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property
        of https://www.carsstore7x24.in/ or used with permission. You may not
      ...
      <p>
        ...
        https://www.carsstore7x24.in/ and its licensors. Service is protected by
        ...
        without the prior written consent of https://www.carsstore7x24.in/.
      </p>
      <p>
      ...
      <p>
        ...
        to carsstore7x24@gmail.com, with the subject line: “Copyright
      ...
      <p>
        You may provide us either directly at carsstore7x24@gmail.com or via
      ...
      <p>
        ...
        are not owned or controlled by https://www.carsstore7x24.in/.
      </p>
      <p>
        https://www.carsstore7x24.in/ has no control over, and assumes no
      ...
      <p>
        ...
        email: <b>carsstore7x24@gmail.com</b>.
      </p>
    </div>
  );
}
