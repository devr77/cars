        ...
        <header className="bg-white">
          <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              <a className="block text-teal-600 text-2xl" href="#">
                CarStore
              </a>
                ...
                <nav aria-label="Global">
                  <ul className="flex items-center gap-6 text-sm font-bold">
                    ...
                    >
                      ...
                      <div class="absolute w-full bg-white top-full bg-stone-50 origine-top opacity-0 hidden flex-col group-hover/bouton:flex group-hover/bouton:opacity-100 transition-all">
                        <div
